		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<?php 
							  ...
							  if (get_post_meta( get_the_ID(), 'rnr_project_video_type', true ) == 'vimeo') {  
								  echo '<div id="portfolio-video"><embed src="http://cloud.video.taobao.com/play/u/611232217/e/1/t/1/p/1/'.get_post_meta( get_the_ID(), 'rnr_project_video_embed', true ).'.swf" quality="high" width="100%" height=580 align="middle" allowScriptAccess="never" allowFullScreen="true" type="application/x-shockwave-flash"></embed></div>';  
							  }  
							  else if (get_post_meta( get_the_ID(), 'rnr_project_video_type', true ) == 'youtube') {  
								  echo '<div id="portfolio-video"><script src="http://api.video.taobao.com//video/getPlayerJS"></script><script src="http://api.video.taobao.com//video/embedVideo?vid='.get_post_meta( get_the_ID(), 'rnr_project_video_embed', true ).'&uid=611232217&tid=1&autoplay=true"></script></div>'; 
							  } 
