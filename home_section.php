...
<?php $detect = new Mobile_Detect;
	         //var_dump($smof_data); rnr_home_type
 if($smof_data['rnr_home_type']=="Video") { 
      ...
      <?php } else if($smof_data['rnr_home_video_type']=="customer"){ ?>
      <div class="ashuwp-bg-video">
        <video id="ashuwpbgvid" loop="" autoplay="" >
          <source src="<?php echo $smof_data['rnr_home_video_id']; ?>" type="video/mp4">
        </video>
      </div>
      <a href="#" class="rnr-video-control rnr-mute">Unmute</a>
      <?php } ?>
