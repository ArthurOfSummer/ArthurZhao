...
<?php if($smof_data['rnr_social_email'] != "") { ?>
    <div class="social-icon social-email"><a href="mailto:<?php echo $smof_data['rnr_social_email']; ?>" title="<?php _e( '微电影拍摄制作', 'rocknrolla' ) ?>"><?php _e( 'Email', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_aim'] != "") { ?>
    <div class="social-icon social-aim"><a href="<?php echo $smof_data['rnr_social_aim']; ?>" target="_blank" title="<?php _e( '宣传片拍摄制作', 'rocknrolla' ) ?>"><?php _e( 'Aim', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_apple'] != "") { ?>
    <div class="social-icon social-apple"><a href="<?php echo $smof_data['rnr_social_apple']; ?>" target="_blank" title="<?php _e( '广州宣传片拍摄', 'rocknrolla' ) ?>"><?php _e( 'Apple', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_behance'] != "") { ?>
    <div class="social-icon social-behance"><a href="<?php echo $smof_data['rnr_social_behance']; ?>" target="_blank" title="<?php _e( '广州视频剪辑', 'rocknrolla' ) ?>"><?php _e( 'Behance', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_blogger'] != "") { ?>
    <div class="social-icon social-blogger"><a href="<?php echo $smof_data['rnr_social_blogger']; ?>" target="_blank" title="<?php _e( '广州视频调色', 'rocknrolla' ) ?>"><?php _e( 'Blogger', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_delicious'] != "") { ?>
    <div class="social-icon social-delicious"><a href="<?php echo $smof_data['rnr_social_delicious']; ?>" target="_blank" title="<?php _e( '广州微电影制作', 'rocknrolla' ) ?>"><?php _e( 'Delicious', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_deviantart'] != "") { ?>
    <div class="social-icon social-deviantart"><a href="<?php echo $smof_data['rnr_social_deviantart']; ?>" target="_blank" title="<?php _e( 'MG动画制作', 'rocknrolla' ) ?>"><?php _e( 'Deviantart', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_digg'] != "") { ?>
    <div class="social-icon social-digg"><a href="<?php echo $smof_data['rnr_social_digg']; ?>" target="_blank" title="<?php _e( '广州flash制作', 'rocknrolla' ) ?>"><?php _e( 'Digg', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_dribbble'] != "") { ?>
    <div class="social-icon social-dribbble"><a href="<?php echo $smof_data['rnr_social_dribbble']; ?>" target="_blank" title="<?php _e( '动画片制作', 'rocknrolla' ) ?>"><?php _e( 'Dribbble', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_ember'] != "") { ?>
    <div class="social-icon social-ember"><a href="<?php echo $smof_data['rnr_social_ember']; ?>" target="_blank" title="<?php _e( '影视广告公司', 'rocknrolla' ) ?>"><?php _e( 'Ember', 'rocknrolla' ) ?></a></div>
<?php } ?>
<?php if($smof_data['rnr_social_facebook'] != "") { ?>
    <div class="social-icon social-facebook"><a href="<?php echo $smof_data['rnr_social_facebook']; ?>" target="_blank" title="<?php _e( '广州影视公司', 'rocknrolla' ) ?>"><?php _e( 'Facebook', 'rocknrolla' ) ?></a></div>
<?php } ?>
...
<?php if($smof_data['rnr_social_vimeo'] != "") { ?>
    <div class="social-icon social-vimeo"><a href="<?php echo $smof_data['rnr_social_vimeo']; ?>" target="_blank" title="<?php _e( '广州影视制作公司', 'rocknrolla' ) ?>"><?php _e( 'Vimeo', 'rocknrolla' ) ?></a></div>
<?php } ?>
...
<?php if($smof_data['rnr_social_youtube'] != "") { ?>
    <div class="social-icon social-youtube"><a href="<?php echo $smof_data['rnr_social_youtube']; ?>" target="_blank" title="<?php _e( '广州明星经纪公司', 'rocknrolla' ) ?>"><?php _e( 'Youtube', 'rocknrolla' ) ?></a></div>
<?php } ?>   
